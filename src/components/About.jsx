...
// 1. Đừng quên import thêm 2 icon Github và FileText từ lucide-react
    ...
    <section id="about" className="py-24 bg-slate-900 text-slate-50 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          {/* CỘT TRÁI: Hình ảnh/Avatar & Các nút bấm */}
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start">
            
            {/* Khung Avatar (Thêm mb-8 để tạo khoảng cách với 2 nút bên dưới) */}
            <div className="relative w-full max-w-sm aspect-square bg-slate-800/40 border border-slate-700/50 rounded-2xl flex items-center justify-center shadow-lg mb-8">
            ...
            {/* 2. Cụm nút bấm GitHub & CV */}
            <div className="flex w-full max-w-sm gap-4">
              <a 
                href="https://github.com/zNhat" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 bg-slate-800/50 hover:bg-slate-700 border border-slate-700 text-slate-200 py-3 px-4 rounded-xl font-medium transition-all duration-300"
              >
                <Github size={18} />
                GitHub
              </a>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white py-3 px-4 rounded-xl font-medium transition-all duration-300 shadow-lg shadow-blue-900/20"
              >
                <FileText size={18} />
                Xem CV
              </a>
          ...
          <div className="lg:col-span-7 space-y-6 text-slate-400 text-base md:text-lg leading-relaxed">
            ...
            <p>
              I specialize in Java, and building efficient database-driven architectures. When I'm not writing code for employee management systems, you'll find me exploring graphic design or crafting clean UI compositions.
            </p>
